...
#if USE(WRATH)
      /*
        signal emitted whenever the view() changes,
        signal is emitted after the change.
       */
      typedef boost::signals2::signal<void ()> newViewSignal;
      boost::signals2::connection newViewConnect(const newViewSignal::slot_type &S);
#endif
