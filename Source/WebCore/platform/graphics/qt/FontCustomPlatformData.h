...
#if USE(WRATH)
  // handle for wrath for custom font data.
  /*
    .first[0] --> if bold
    .first[1] --> if italic.
   */
  std::map<vecN<bool,2>, WRATHFontDatabase::Font::const_handle> m_custom_fonts;
  std::vector<WRATHFontDatabase::Font::const_handle> m_all_custom_fonts;
  WRATHFontDatabase::Font::const_handle m_fallback;
#endif
