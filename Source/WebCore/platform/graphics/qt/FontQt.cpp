...
{
#if USE(WRATH)
  return DrawnTextOfWRATHData::width(*this, run);
#endif
...
{
#if USE(WRATH)
  return DrawnTextOfWRATHData::offsetForPosition(*this, run, position, includePartialGlyphs);
#endif
...
#if USE(WRATH)
  return DrawnTextOfWRATHData::selectionRectForText(*this, run, pt, h, from, to);
#endif
...
#if USE(WRATH)
WRATHTextureFont *Font::fontOfWRATH() const
{
  return primaryFont()->getWRATHFont();
}
#endif
