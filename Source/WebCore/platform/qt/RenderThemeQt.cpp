...
namespace 
{
  class EmptyTheme:public WebCore::RenderTheme
  {
  public:
    EmptyTheme(WebCore::Page*):
      WebCore::RenderTheme()
    {}

    void systemFont(int, WebCore::FontDescription&) const {}
  };
}
...
{
  return adoptRef(new EmptyTheme(page));
