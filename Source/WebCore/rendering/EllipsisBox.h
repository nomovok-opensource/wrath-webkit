...
public:
    ...
    typedef Signal<EllipsisBox> SignalType;
    ...
    void setSelectionState(RenderObject::SelectionState s) { SET_VALUE_AND_EMIT(m_selectionState, s, m_signal, E_selectionState); }
...
#if USE(WRATH)
    void readyWRATHSelection(PaintedWidgetsOfWRATHHandleT<InlineBox> &handle, 
