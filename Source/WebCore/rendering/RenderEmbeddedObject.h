...
public:
    ...
    {
        E_replacementText,
        E_hasFallbackContent,
        E_showsMissingPluginIndicator,
        E_missingPluginIndicatorIsPressed,
    ...
    void setHasFallbackContent(bool hasFallbackContent) { SET_VALUE_AND_EMIT(m_hasFallbackContent, hasFallbackContent, m_signal, E_hasFallbackContent); }
...
private:
    ...
    void setReplacementText(const String & t) { SET_VALUE_AND_EMIT(m_replacementText, t, m_signal, E_replacementText); }
    ...
    bool getReplacementTextGeometry(int tx, int ty, FloatRect& contentRect, FloatRect& replacementTextRect, Font&, TextRun&, float& textWidth, FloatRect& pathRect);
...
#if USE(WRATH)
protected:
    typedef Signal<RenderEmbeddedObject> SignalType;
