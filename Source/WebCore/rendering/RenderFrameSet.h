...
#if USE(WRATH)
    void readyWRATHWidgetRowBorder(PaintedWidgetsOfWRATHHandle&, const PaintInfoOfWRATH&, const IntRect&);
    void readyWRATHWidgetColumnBorder(PaintedWidgetsOfWRATHHandle&, const PaintInfoOfWRATH&, const IntRect&);
#endif
...
#if USE(WRATH)
protected:
    typedef Signal<RenderFrameSet> SignalType;
