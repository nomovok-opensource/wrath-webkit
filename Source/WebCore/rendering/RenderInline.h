...
public:
...
#if USE(WRATH)
    void readyWRATHWidgetOutline(PaintedWidgetsOfWRATHHandle&, ContextOfWRATH*,
                                  int tx, int ty);
#endif
    ...
    void setAlwaysCreateLineBoxes(bool b=true)
    {
        SET_VALUE_AND_EMIT(m_alwaysCreateLineBoxes, b, m_signal, E_alwaysCreateLineBoxes);
    }
...
#if USE(WRATH)
    void readyWRATHWidgetOutlineForLine(PaintedWidgetsOfWRATHHandle&, 
                                        ContextOfWRATH*,
                                        int tx, int ty, 
                                        const IntRect& prevLine, const IntRect& thisLine, const IntRect& nextLine);
#endif
...
#if USE(WRATH)
protected:
    typedef Signal<RenderInline> SignalType;
