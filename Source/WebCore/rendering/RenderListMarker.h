...
private:
    ...
    void setTextMember(const String & t) { SET_VALUE_AND_EMIT(m_text, t, m_signal, E_text); }
    void setTextMember(const char * t)
    {
        String txt(t);
        setTextMember(txt);
    }
...
#if USE(WRATH)
protected:
    typedef Signal<RenderListMarker> SignalType;
