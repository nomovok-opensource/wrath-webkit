...
protected:
    ...
    void setHasIntrinsicSize() { SET_VALUE_AND_EMIT(m_hasIntrinsicSize, true, m_signal, E_hasIntrinsicSize); }

    virtual void paint(PaintInfo&, int tx, int ty);

#if USE(WRATH)
    virtual void readyWRATHWidgets(PaintedWidgetsOfWRATHHandle& handle,
...
#if USE(WRATH)
protected:
    typedef Signal<RenderReplaced> SignalType;
