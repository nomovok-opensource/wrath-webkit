...
public:
    ...
    enum MemberChange
    {
        ...
        E_rowSpan,
        E_columnSpan,
        E_intrinsicPaddingBefore,
        E_intrinsicPaddingAfter,
        E_numberOfChanges
    };
#endif
    ...
    void setColSpan(int c) { SET_VALUE_AND_EMIT(m_columnSpan, c, m_signal, E_columnSpan); }

    int rowSpan() const { return m_rowSpan; }
    void setRowSpan(int r) { SET_VALUE_AND_EMIT(m_rowSpan, r, m_signal, E_rowSpan); }

    int col() const { return m_column; }
    void setCol(int col) { SET_VALUE_AND_EMIT(m_column, col, m_signal, E_column); }
    int row() const { return m_row; }
    void setRow(int row) { SET_VALUE_AND_EMIT(m_row, row, m_signal, E_row); }
    ...
    void readyWRATHWidgetBackgroundsBehindCell(PaintedWidgetsOfWRATHHandle&,
                                               PaintInfoOfWRATH&, int tx, int ty,
    ...
    void setIntrinsicPaddingBefore(int p) { SET_VALUE_AND_EMIT(m_intrinsicPaddingBefore, p, m_signal, E_intrinsicPaddingBefore); }
    void setIntrinsicPaddingAfter(int p) { SET_VALUE_AND_EMIT(m_intrinsicPaddingAfter, p, m_signal, E_intrinsicPaddingAfter); }
    ...
    void setCellWidthChanged(bool b = true) { SET_VALUE_AND_EMIT(m_cellWidthChanged, b, m_signal, E_cellWidthChanged); }
...
#if USE(WRATH)
    virtual void readyWRATHWidgetBoxDecorations(PaintedWidgetsOfWRATHHandle&,
                                                PaintInfoOfWRATH&, int tx, int ty);
    virtual void readyWRATHWidgetMask(PaintedWidgetsOfWRATHHandle&,
                                      PaintInfoOfWRATH&, int tx, int ty);
...
#if USE(WRATH)
    void readyWRATHWidgetCollapsedBorder(PaintedWidgetsOfWRATHHandle& handle,
                                         ContextOfWRATH*,
...
#if USE(WRATH)
protected:
    typedef Signal<RenderTableCell> SignalType;
