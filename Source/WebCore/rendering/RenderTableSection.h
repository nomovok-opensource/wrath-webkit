...
public:
    ...
    enum MemberChange
    {
        ...
        E_cRow,
        E_needsCellRecalc,
        E_hasOverflowingCell,
        E_hasMultipleCellLevels,
        E_numberOfChanges
    };
#endif
...
private:
    ...
    virtual void readyWRATHWidgetCell(PaintedWidgetsOfWRATHHandle&,
                                      RenderTableCell*, PaintInfoOfWRATH&, int tx, int ty);
    ...
    void setGridRows(int r) { SET_VALUE_AND_EMIT(m_gridRows, r, m_signal, E_gridRows); }

    void setCCol(int c) { SET_VALUE_AND_EMIT(m_cCol, c, m_signal, E_cCol); }
    void setCRow(int r) { SET_VALUE_AND_EMIT(m_cRow, r, m_signal, E_cRow); }
    ...
    void setNeedsCellRecalc(bool b) { SET_VALUE_AND_EMIT(m_needsCellRecalc, b, m_signal, E_needsCellRecalc); }
    void setHasOverflowingCell(bool b = true) { SET_VALUE_AND_EMIT(m_hasOverflowingCell, b, m_signal, E_hasOverflowingCell); }
    void setHasMultipleCellLevels(bool b) { SET_VALUE_AND_EMIT(m_hasMultipleCellLevels, b, m_signal, E_hasMultipleCellLevels); }
...
#if USE(WRATH)
protected:
    typedef Signal<RenderTableSection> SignalType;
