...
void RenderTextControlSingleLine::showPopup()
{
    ...
    SET_VALUE_AND_EMIT(m_searchPopupIsVisible, true, m_signal, E_searchPopupIsVisible);
...
{
    SET_VALUE_AND_EMIT(m_searchPopupIsVisible, false, m_signal, E_searchPopupIsVisible);
}
