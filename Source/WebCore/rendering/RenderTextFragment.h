...
private:
    ...
    void setStart(unsigned s) { SET_VALUE_AND_EMIT(m_start, s, m_signal, E_start); }
    void setEnd(unsigned e) { SET_VALUE_AND_EMIT(m_end, e, m_signal, E_end); }

    unsigned m_start;
    unsigned m_end;
    RefPtr<StringImpl> m_contentString;
    RenderObject* m_firstLetter; // Nothing writes to this, except value 0...

#if USE(WRATH)
protected:
    typedef Signal<RenderTextFragment> SignalType;
