...
#if USE(WRATH)
  // analgoues to paint, paintBorderOnly and paintDecoration.
  // The handles are associated to the RenderObject passed.
  // However, they will set the visibility of the handle to
  // the NOT of the return value!
  bool readyWRATHWidgets(RenderObject*, PaintedWidgetsOfWRATHHandle&,
                         const PaintInfoOfWRATH&, const IntRect&);
  bool readyWRATHWidgetBorderOnly(RenderObject*, PaintedWidgetsOfWRATHHandle&,
                                  const PaintInfoOfWRATH&, const IntRect&);

  bool readyWRATHWidgetDecorations(RenderObject*, PaintedWidgetsOfWRATHHandle&,
                                   const PaintInfoOfWRATH&, const IntRect&);
#endif
...
protected:
  ...
  #if USE(WRATH)
    /*
       WRATH analgoues to above paintFoo methods
       [WRATH-TODO] these methods are "empty" do 
       nothing methds, which are implemented in 
       RenderThemeQt.cpp.
     */
    virtual bool readyWRATHWidgetCheckbox(PaintedWidgetsOfWRATHHandle&,
                                          RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetRadio(PaintedWidgetsOfWRATHHandle&,
                                       RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetButton(PaintedWidgetsOfWRATHHandle&,
                                        RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetInnerSpinButton(PaintedWidgetsOfWRATHHandle&,
                                                 RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetOuterSpinButton(PaintedWidgetsOfWRATHHandle&,
                                                 RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
  #endif
    ...
    /*
       ...
       RenderThemeQt.cpp.
     */
    virtual bool readyWRATHWidgetTextField(PaintedWidgetsOfWRATHHandle&,
                                           RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetTextArea(PaintedWidgetsOfWRATHHandle&,
                                          RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetMenuList(PaintedWidgetsOfWRATHHandle&,
                                          RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
    virtual bool readyWRATHWidgetMenuListButton(PaintedWidgetsOfWRATHHandle&,
                                                RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
#endif
    ...
    /*
       ...
       RenderThemeQt.cpp.
     */
      virtual bool readyWRATHWidgetMeter(PaintedWidgetsOfWRATHHandle&,
                                         RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
  #endif
#endif
    ...
    /*
       ...
       RenderThemeQt.cpp.
     */
      virtual bool readyWRATHWidgetProgressBar(PaintedWidgetsOfWRATHHandle&,
                                               RenderObject*, const PaintInfoOfWRATH&, const IntRect&){ return true; }
  #endif
#endif
  ...
  #if USE(WRATH)
      virtual bool readyWRATHWidgetInputFieldSpeechButton(PaintedWidgetsOfWRATHHandle&,
                                                          RenderObject*, const PaintInfoOfWRATH&, const IntRect&);
  #endif
#endif
    ...
    /*
       ...
       RenderThemeQt.cpp.
     */
    virtual bool readyWRATHWidgetSliderTrack(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetSliderThumb(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetSearchField(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetSearchFieldCancelButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetSearchFieldDecoration(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetSearchFieldResultsDecoration(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetSearchFieldResultsButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }

    virtual bool readyWRATHWidgetMediaFullscreenButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaPlayButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaMuteButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaSeekBackButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaSeekForwardButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaSliderTrack(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaSliderThumb(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaVolumeSliderContainer(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaVolumeSliderTrack(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaVolumeSliderThumb(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaRewindButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaReturnToRealtimeButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaToggleClosedCaptionsButton(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaControlsBackground(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaCurrentTime(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
    virtual bool readyWRATHWidgetMediaTimeRemaining(PaintedWidgetsOfWRATHHandle&,RenderObject*, const PaintInfoOfWRATH&, const IntRect&) { return true; }
#endif
