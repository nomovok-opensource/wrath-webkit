...
public:
    ...
    enum MemberChange
    {
        E_layoutDisableCount,
        E_pageLogicalHeight,
        E_layoutState,
        E_layoutStateDisableCount,
        E_widgets,
        E_maximalOutlineSize,
        E_selection,
        E_numberOfChanges
    };
#endif
...
#else
    void setMaximalOutlineSize(int o) { SET_VALUE_AND_EMIT(m_maximalOutlineSize, o, m_signal, E_maximalOutlineSize); }
#endif
    ...
    void disableLayoutState()
    { 
        m_layoutStateDisableCount++;
#if USE(WRATH)
        m_signal(E_layoutStateDisableCount);
#endif
    }
...
#if USE(WRATH)
protected:
    typedef Signal<RenderView> SignalType;
