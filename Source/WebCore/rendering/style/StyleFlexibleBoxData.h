...
public:
    ...
    float m_flex;
    unsigned int m_flexGroup;
    unsigned int m_ordinalGroup;

    unsigned m_align : 3; // EBoxAlignment
    unsigned m_pack: 3; // EBoxAlignment
    unsigned m_orient: 1; // EBoxOrient
    unsigned m_lines : 1; // EBoxLines
