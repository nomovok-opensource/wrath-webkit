...
public:
    ...
    int m_loops; // -1 means infinite.

    unsigned m_behavior : 2; // EMarqueeBehavior 
    EMarqueeDirection m_direction : 3; // not unsigned because EMarqueeDirection has negative values
