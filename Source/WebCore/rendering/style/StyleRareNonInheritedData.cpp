...
StyleRareNonInheritedData::StyleRareNonInheritedData()
    : m_lineClamp(RenderStyle::initialLineClamp())
    , m_opacity(RenderStyle::initialOpacity())
    , m_userDrag(RenderStyle::initialUserDrag())
    , m_textOverflow(RenderStyle::initialTextOverflow())
    , m_marginBeforeCollapse(MCOLLAPSE)
    , m_marginAfterCollapse(MCOLLAPSE)
    , m_matchNearestMailBlockquoteColor(RenderStyle::initialMatchNearestMailBlockquoteColor())
...
StyleRareNonInheritedData::StyleRareNonInheritedData(const StyleRareNonInheritedData& o)
    ...
    , m_lineClamp(o.m_lineClamp)
    , m_opacity(o.m_opacity)
    , m_flexibleBox(o.m_flexibleBox)
    , m_marquee(o.m_marquee)
    , m_multiCol(o.m_multiCol)
    , m_transform(o.m_transform)
    , m_userDrag(o.m_userDrag)
    , m_textOverflow(o.m_textOverflow)
    , m_marginBeforeCollapse(o.m_marginBeforeCollapse)
    , m_marginAfterCollapse(o.m_marginAfterCollapse)
    , m_matchNearestMailBlockquoteColor(o.m_matchNearestMailBlockquoteColor)
...
{
    return m_lineClamp == o.m_lineClamp
