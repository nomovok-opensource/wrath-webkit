...
public:
    ...
    {
        return ( m_clip == o.m_clip &&
                 m_hasClip == o.m_hasClip &&
                 m_textDecoration == o.m_textDecoration &&
                 m_zoom == o.m_zoom);
    }
    ...
    LengthBox m_clip;
    bool m_hasClip : 1;
    unsigned m_textDecoration : 4; // Text decorations defined *only* by this element.
