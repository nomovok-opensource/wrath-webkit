...
# Include WRATH project configuration
release: include(../../wrath/release/QtLibConf.pri)
debug: include(../../wrath/debug/QtLibConf.pri)
...
*-g++*:QMAKE_LFLAGS += -Wl,--no-keep-memory
...
# Ease up on that debugging info
